...
A Versão 3 resolve o gargalo de serialização da Versão 2 ao custo de maior uso de memória (cada Thread consome sua própria pilha) e da necessidade de sincronização caso recursos compartilhados sejam introduzidos futuramente. Para workloads de I/O como este projeto, o ganho de performance é imediato e expressivo.
